...
var theme = materialUi.createMuiTheme({
    palette: {
        ...
        primary: {
            ...
            light: index$1.blueGrey[300],
            dark: index$1.blueGrey[700]
        },
        secondary: {
            main: index$1.lightBlue[600],
            light: index$1.lightBlue[300],
            dark: index$1.lightBlue[700]
        },
        error: {
            light: index$1.red.A200,
            main: index$1.red.A400,
            dark: index$1.red.A700
        },
        warning: {
            light: index$1.orange.A200,
            main: index$1.orange.A400,
            dark: index$1.orange.A700
        },
        success: {
            light: index$1.green.A200,
            main: index$1.green.A400,
            dark: index$1.green.A700
        }
    }
});
