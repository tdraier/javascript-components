(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('material-ui/styles/index'), require('lodash'), require('react-apollo'), require('graphql-tag'), require('@jahia/apollo-dx'), require('react-redux'), require('material-ui'), require('material-ui-icons'), require('redux'), require('react-flexbox-grid'), require('history'), require('react-router'), require('react-router-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'material-ui/styles/index', 'lodash', 'react-apollo', 'graphql-tag', '@jahia/apollo-dx', 'react-redux', 'material-ui', 'material-ui-icons', 'redux', 'react-flexbox-grid', 'history', 'react-router', 'react-router-dom'], factory) :
	(factory((global.jahia = global.jahia || {}, global.jahia.reactcomponents = {}),global.React,global.ReactDOM,global.materialUiStyles,global._,global.reactApollo,global.gql,global.jahia.apollodx,global.reactRedux,global.materialUi,global.materialUiIcons,global.redux,global.reactFlexboxGrid,global.history,global.reactRouter,global.reactRouterDom));
}(this, (function (exports,React,ReactDOM,index,_$1,reactApollo,gql,apolloDx,reactRedux,materialUi,materialUiIcons,redux,reactFlexboxGrid,history,reactRouter,reactRouterDom) { 'use strict';
...
var PickerData = function (_React$Component) {
    ...
    createClass(PickerData, [{
        ...
        value: function mapResultsToProps(_ref) {
            ...
            var openPaths = ownProps.openPaths;
        ...
        value: function mapPropsToOptions(props) {
            var fullyOpenPath = function fullyOpenPath(props, path) {
                ...
                _$1.tail(_$1.split(path, "/")).reduce(function (acc, it) {
                    ...
                    if (rootFound && _$1.indexOf(props.openPaths, acc) === -1) {
