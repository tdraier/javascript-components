(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('material-ui'), require('material-ui/styles/index'), require('i18next'), require('i18next-xhr-backend'), require('react-i18next'), require('redux'), require('lodash'), require('material-ui/colors/index'), require('@jahia/apollo-dx'), require('react-apollo'), require('react-redux'), require('react-router-dom'), require('history'), require('react-router'), require('prop-types'), require('react-jss'), require('react-dom'), require('graphql-tag'), require('material-ui-icons'), require('material-ui/styles/colorManipulator')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'material-ui', 'material-ui/styles/index', 'i18next', 'i18next-xhr-backend', 'react-i18next', 'redux', 'lodash', 'material-ui/colors/index', '@jahia/apollo-dx', 'react-apollo', 'react-redux', 'react-router-dom', 'history', 'react-router', 'prop-types', 'react-jss', 'react-dom', 'graphql-tag', 'material-ui-icons', 'material-ui/styles/colorManipulator'], factory) :
	(factory((global.jahia = global.jahia || {}, global.jahia.reactcomponents = {}),global.React,global.materialUi,global.materialUiStyles,global.i18n,global.XHR,global.reactI18next,global.redux,global._,global.index$1,global.jahia.apollodx,global.reactApollo,global.reactRedux,global.reactRouterDom,global.history,global.reactRouter,global.PropTypes,global.reactJss,global.ReactDOM,global.gql,global.materialUiIcons,global.colorManipulator));
}(this, (function (exports,React,materialUi,index,i18n,XHR,reactI18next,redux,_,index$1,apolloDx,reactApollo,reactRedux,reactRouterDom,history,reactRouter,PropTypes,reactJss,ReactDOM,gql,materialUiIcons,colorManipulator) { 'use strict';
...
var DxContextProvider = function (_React$Component) {
    ...
    createClass(DxContextProvider, [{
        ...
        value: function render() {
            ...
            // add notification
            Component$$1 = React__default.createElement(NotificationProvider, { notificationContext: {} }, Component$$1);
...
exports.PickerViewMaterial = function PickerViewMaterial(props) {
    ...
    return React__default.createElement(
        materialUi.List,
        { classes: { root: classes.root, padding: classes.padding } },
        pickerEntries.map(function (entry) {
            return React__default.createElement(
                ...
                React__default.createElement(
                    ...
                    { classes: entry.selected ? { root: classes.selectedText } : {} },
                    ...
                    ) : React__default.createElement(materialUiIcons.ExpandMore, { style: { opacity: 0 } })
                ),
                React__default.createElement(
                    materialUi.ListItemIcon,
                    { classes: entry.selected ? { root: classes.selectedText } : {},
                ...
                React__default.createElement(materialUi.ListItemText, { classes: entry.selected ? { primary: classes.selectedText } : {}, inset: true,
