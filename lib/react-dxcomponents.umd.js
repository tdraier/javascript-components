(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('material-ui'), require('i18next'), require('i18next-xhr-backend'), require('react-i18next'), require('redux'), require('lodash'), require('@jahia/apollo-dx'), require('react-apollo'), require('react-redux'), require('react-router-dom'), require('history'), require('react-router'), require('prop-types'), require('react-dom'), require('graphql-tag'), require('material-ui-icons')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'material-ui', 'i18next', 'i18next-xhr-backend', 'react-i18next', 'redux', 'lodash', '@jahia/apollo-dx', 'react-apollo', 'react-redux', 'react-router-dom', 'history', 'react-router', 'prop-types', 'react-dom', 'graphql-tag', 'material-ui-icons'], factory) :
	(factory((global.jahia = global.jahia || {}, global.jahia.reactcomponents = {}),global.React,global.materialUi,global.i18n,global.XHR,global.reactI18next,global.redux,global._,global.jahia.apollodx,global.reactApollo,global.reactRedux,global.reactRouterDom,global.history,global.reactRouter,global.PropTypes,global.ReactDOM,global.gql,global.materialUiIcons));
}(this, (function (exports,React,materialUi,i18n,XHR,reactI18next,redux,_,apolloDx,reactApollo,reactRedux,reactRouterDom,history,reactRouter,PropTypes,ReactDOM,gql,materialUiIcons) { 'use strict';
...
var DxContextProvider = function (_React$Component) {
    ...
    createClass(DxContextProvider, [{
        ...
        value: function render() {
            ...
            if (mui) {
                Component$$1 = React__default.createElement(materialUi.MuiThemeProvider, { theme: theme }, Component$$1);
            }
            return Component$$1;
        }
    }]);
