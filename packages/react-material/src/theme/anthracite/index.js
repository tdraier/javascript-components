...
const anthraciteLightThemeOverrides = (theme) => ({
    ...
    MuiCheckbox: anthraciteCheckbox,
    ...
    MuiMenu: anthraciteMenu,
    MuiMenuItem: anthraciteMenuItem,
    ...
    MuiPaper: anthracitePaper,
    MuiSelect: anthraciteSelect,
    MuiTable: anthraciteTable,
    MuiTableRow: anthraciteTableRow,
    MuiTableCell: anthraciteTableCell,
    MuiTab: anthraciteTab,
    MuiTabs: anthraciteTabs,
