(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('material-ui'), require('i18next'), require('i18next-xhr-backend'), require('react-i18next'), require('redux'), require('lodash'), require('material-ui/colors/index'), require('@jahia/apollo-dx'), require('react-apollo'), require('react-redux'), require('react-router-dom'), require('history'), require('react-router'), require('prop-types'), require('react-dom'), require('graphql-tag'), require('material-ui-icons')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'material-ui', 'i18next', 'i18next-xhr-backend', 'react-i18next', 'redux', 'lodash', 'material-ui/colors/index', '@jahia/apollo-dx', 'react-apollo', 'react-redux', 'react-router-dom', 'history', 'react-router', 'prop-types', 'react-dom', 'graphql-tag', 'material-ui-icons'], factory) :
	(factory((global.jahia = global.jahia || {}, global.jahia.reactcomponents = {}),global.React,global.materialUi,global.i18n,global.XHR,global.reactI18next,global.redux,global._,global.index,global.jahia.apollodx,global.reactApollo,global.reactRedux,global.reactRouterDom,global.history,global.reactRouter,global.PropTypes,global.ReactDOM,global.gql,global.materialUiIcons));
}(this, (function (exports,React,materialUi,i18n,XHR,reactI18next,redux,_,index,apolloDx,reactApollo,reactRedux,reactRouterDom,history,reactRouter,PropTypes,ReactDOM,gql,materialUiIcons) { 'use strict';
...
var theme = materialUi.createMuiTheme({
    palette: {
        background: {
            global: index.grey[200]
        },
        contrastThreshold: 3.1,
        tonalOffset: 0.07,
        primary: {
            main: index.blueGrey[600],
            light: index.blueGrey[300],
            dark: index.blueGrey[700]
        },
        secondary: {
            main: index.lightBlue[600],
            light: index.lightBlue[300],
            dark: index.lightBlue[700]
        },
        error: {
            light: index.red.A200,
            main: index.red.A400,
            dark: index.red.A700
        },
        warning: {
            light: index.orange.A200,
            main: index.orange.A400,
            dark: index.orange.A700
        },
        success: {
            light: index.green.A200,
            main: index.green.A400,
            dark: index.green.A700
        }
    }
});
...
var darkTheme = materialUi.createMuiTheme({
    palette: {
        type: "dark",
        background: {
            global: index.grey[900]
        },
        contrastThreshold: 3.0,
        tonalOffset: 0.2,
        primary: {
            main: index.purple[500]
        },
        secondary: {
            main: index.green[400]
        },
        error: {
            main: index.red[200]
        }
...
var DxContextProvider = function (_React$Component) {
    ...
    function DxContextProvider(props) {
        ...
        if (props.mui && _typeof(props.mui) === 'object') {
            _this.state = {
                theme: props.mui
            };
        }
        props.dxContext.setTheme = function (theme) {
            _this.setState({
                theme: theme
            });
        };
    ...
    createClass(DxContextProvider, [{
        ...
        value: function render() {
            ...
            if (apollo) {
                var _options2 = { contextPath: dxContext.contextPath };
                if ((typeof apollo === 'undefined' ? 'undefined' : _typeof(apollo)) === 'object') {
                    Object.assign(_options2, apollo);
                }
                Component$$1 = React__default.createElement(reactApollo.ApolloProvider, { client: apolloDx.client(_options2) }, Component$$1);
            }
            if (redux$$1) {
            ...
            if (mui) {
                ...
                Component$$1 = React__default.createElement(materialUi.MuiThemeProvider, { theme: theTheme }, Component$$1);
            }
            return Component$$1;
        }
    }]);
