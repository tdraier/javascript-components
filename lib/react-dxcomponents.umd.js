(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('react-apollo'), require('graphql-tag'), require('lodash'), require('@jahia/apollo-dx'), require('prop-types'), require('react-redux'), require('material-ui'), require('material-ui-icons'), require('redux'), require('history'), require('react-router'), require('react-router-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'react-apollo', 'graphql-tag', 'lodash', '@jahia/apollo-dx', 'prop-types', 'react-redux', 'material-ui', 'material-ui-icons', 'redux', 'history', 'react-router', 'react-router-dom'], factory) :
	(factory((global.jahia = global.jahia || {}, global.jahia.reactcomponents = {}),global.React,global.ReactDOM,global.reactApollo,global.gql,global._,global.jahia.apollodx,global.PropTypes,global.reactRedux,global.materialUi,global.materialUiIcons,global.redux,global.history,global.reactRouter,global.reactRouterDom));
}(this, (function (exports,React,ReactDOM,reactApollo,gql,_$1,apolloDx,PropTypes,reactRedux,materialUi,materialUiIcons,redux,history,reactRouter,reactRouterDom) { 'use strict';
        ...
        value: function render() {
            ...
            if (cacheMatch) {
                ...
                Component$$1 = reactApollo.graphql(query, {
                    props: this.mapResultsToProps,
                    options: this.mapPropsToOptions
                })(renderComponent || this.props.multipleSelection ? exports.PickerViewMaterialMultiple : exports.PickerViewMaterial);
    ...
    createClass(PickerRedux, [{
        ...
        value: function openPaths() {
            ...
            return function () {
                ...
                if (action.type === 'OPEN_PICKER_ENTRY_' + _this2.props.id && index === -1) {
                    return [].concat(toConsumableArray(state), [action.path]);
                } else if (action.type === 'CLOSE_PICKER_ENTRY_' + _this2.props.id && index !== -1) {
        ...
        value: function selectedPaths() {
            ...
            return function () {
                ...
                var index = state.indexOf(action.path);
                if (action.type === 'SELECT_PICKER_ENTRY_' + _this4.props.id && index === -1) {
                    return [].concat(toConsumableArray(state), [action.path]);
                } else if (action.type === 'UNSELECT_PICKER_ENTRY_' + _this4.props.id && index !== -1) {
                    return _.filter(state, function (path) {
                        return path !== action.path;
                    });
                }
