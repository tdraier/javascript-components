            ...
            pickerEntries.map(function (entry) {
                return React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        { className: entry.selected ? classes.listItemToggle + ' ' + classes.selectedText : classes.listItemToggle, style: { paddingLeft: (entry.depth + 1) * 20 } },
                        ...
                        ) : React__default.createElement(materialUiIcons.KeyboardArrowDown, { className: entry.selected ? classes.toggleSelected : classes.toggleUnSelected })
                    ),
                    React__default.createElement(
                        materialUi.ListItemIcon,
