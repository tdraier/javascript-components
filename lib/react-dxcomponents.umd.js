		...
		MuiFormHelperText: {
			root: {
				...
				"& message": (_message = {
					...
					borderRadius: '2px',
					color: 'white'
				}, defineProperty(_message, 'padding', '14px'), defineProperty(_message, 'lineHeight', 'normal'), _message),
				"& label": {}
			}
		},
		MuiTypography: {
...
exports.SettingsLayout = materialUi.withStyles(styles, { name: "DxSettingsLayout" })(exports.SettingsLayout);
...
exports.SearchBar = function (_React$Component) {
    ...
    createClass(SearchBar, [{
        ...
        value: function render() {
            ...
            return React__default.createElement(materialUi.Input, { classes: { root: this.state.focus ? classes.rootFocus : classes.root, input: this.state.focus ? classes.inputFocus : classes.input },
...
exports.SearchBar = materialUi.withStyles(styles$1, { name: "DxSearchBar" })(reactI18next.translate('react-dxcomponents')(exports.SearchBar));
            ...
            pickerEntries.map(function (entry) {
                return React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        { className: entry.selected ? classes.listItemToggle + ' ' + classes.selectedText : classes.listItemToggle, style: { paddingLeft: (entry.depth + 1) * 20, opacity: entry.openable && entry.hasChildren ? 1 : 0 } },
                        React__default.createElement(
                            materialUi.IconButton,
                            { className: classes.buttonContainer, onClick: function onClick(event) {
                                    onOpenItem(entry.path, !entry.open);event.stopPropagation();
                                }, disabled: !(entry.openable && entry.hasChildren) },
                            entry.open ? React__default.createElement(materialUiIcons.KeyboardArrowDown, { className: entry.selected ? classes.toggleSelected : classes.toggleUnSelected }) : React__default.createElement(materialUiIcons.KeyboardArrowRight, { className: entry.selected ? classes.toggleSelected : classes.toggleUnSelected })
                        )
                    ),
                    React__default.createElement(
                        materialUi.ListItemIcon,
...
exports.PickerViewMaterial = materialUi.withTheme()(materialUi.withStyles(styles$2, { name: "DxPickerViewMaterial" })(exports.PickerViewMaterial));
