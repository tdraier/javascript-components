...
exports.default = function (context) {
    ...
    return reactRender(context.currentNode.getProperty('react:componentPackage'), context.currentNode.getProperty('react:componentType'), 'react_' + context.currentNode.identifier.replaceAll('-','_'),
        {}
    );
};
